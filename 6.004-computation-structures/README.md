...
**Prerequisites:** 6.002 (device view), 6.042 (proofs/state machines helpful)
**Feeds into:** 6.191 (embedded), 6.033 (systems), CS phase generally
...
| Control signals for datapath operations | not started |
| Instruction fetch & PC update | not started |
| Single-cycle datapath: decode/execute | not started |
| Control unit (FSM) for a simple ISA | not started |
| Pipelining motivation & staging | not started |
| Data hazards (forwarding, stalling) | not started |
| Control & structural hazards | not started |
| Memory technology basics (SRAM/DRAM) & addressing | not started |
| Cache concept & direct-mapped caches | not started |
| Cache hits/misses & associativity intro | not started |
| ISA components (registers, instruction formats) | not started |
| Assembly instructions & addressing modes | not started |
| Assembler/linker basics | not started |
